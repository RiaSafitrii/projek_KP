        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Data Storage</h4>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('storage.store') }}" id="formadd" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success waves-effect btn-label waves-light" name="sb"><i class="mdi mdi-checkbox-marked-circle-plus-outline label-icon"></i>Add</button>
                                    </div>
                                </form>
                                <script>
                                    ...
                                    <div class="card">
                                        <div class="folder">
                                            <a href="">
                                                ...
                                                <span class="ms-1 text-muted font-size-13">Nama Folder</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="pdf">
                                            <a href="">
                                                ...
                                                <span class="ms-1 text-muted font-size-13">Nama File</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
